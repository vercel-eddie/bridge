...
export declare type Message_Registration = Message$1<"bridge.v1.Message.Registration"> & {
   ...
   *
   * @generated from field: string deployment_id = 1 [json_name = "deployment_id"];
   */
  deploymentId: string;
   ...
   *
   * @generated from field: bool is_server = 2 [json_name = "is_server"];
   */
  isServer: boolean;
   ...
   *
   * @generated from field: bridge.v1.Message.Protocol protocol = 3;
   */
   ...
   *
   * @generated from field: string function_url = 4 [json_name = "function_url"];
   */
  functionUrl: string;
